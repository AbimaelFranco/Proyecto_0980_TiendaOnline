...
from reconocimiento import extract_embeddings
from reconocimiento import train_model
# load our serialized face detector model from disk

# protoPath = os.path.join(settings.BASE_DIR, '/face_detection_model/deploy.prototxt')
# protoPath = os.path.join('"C:/Users/asana/Desktop/face_detection_model/deploy.prototxt"')
